...
- **Cloud Storage**: Videos and user data stored in Firebase
- **Responsive UI**: Modern UI built with Jetpack Compose
...
```bash
git clone https://github.com/yourusername/xyzen-assignment.git
cd xyzen-assignment/frontend
